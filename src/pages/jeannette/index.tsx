      ...
      <main className="pt-16">
        ...
        <section className="py-10 md:py-14 bg-white text-left border-y border-gray-200">
          <div className="container mx-auto px-4 space-y-6 text-base text-gray-800 leading-relaxed max-w-4xl">
            <p>Jeannette Weiss Gruber a consacré sa vie au vitrail. Elle peignait sur le verre en cherchant sa propre lumière, sa grisaille, en dialogue constant avec les vitraux anciens et l’architecture des édifices.</p>
            ...
            <p className="text-sm text-gray-600">Le code de ce site est <a href="https://github.com/13w13/weiss-gruber" className="underline" target="_blank" rel="noopener noreferrer">open source</a> sous licence CC0 (domaine public), co-développé avec LLMs, et peut être réutilisé sans demande d&apos;autorisation.</p>
